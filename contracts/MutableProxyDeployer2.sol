...
PROXY BINARY CODE:
    ...
    
*/

contract MutableProxyDeployer2 {
    ...
    function deployProxy(address controller, address owner, address implementation) public returns(address){
        ...
        assembly{
            ...
            mstore(add(code,88),or(0xF36014600C6000807300000000000000000000000000000000000000005AFA60,shl(24,controller)))
            mstore(add(code,120),0x005136600080373636600080935AF43D6000803E603A573D6000FD5B3D6000F3)
